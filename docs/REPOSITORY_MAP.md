...
- `atelier_agent/eval/fixtures/docqa_corpus/` owns the frozen historical
  document-QA inputs; they are benchmark fixtures, not current documentation.
...
- `docs/archive/` owns historical implementation reports and merge records.

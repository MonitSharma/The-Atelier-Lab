...
**Production connection.** This module maps directly to the existing ReAct loop, registry, RAG, memory, and eval suites. **Read.** `atelier_agent/docs/EVAL.md`. **Exit.** Name the observable signal that makes an agent result trustworthy.
